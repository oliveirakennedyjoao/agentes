distanciasDiretas = {
    'E1': { 'E1': 0, 'E2': 10, 'E3': 18, 'E4': 24.8, 'E5': 36.4, 'E6': 38.8, 'E7': 35.8, 'E8': 25.4, 'E9': 17.6, 'E10': 9.1, 'E11': 16.7, 'E12': 27.3, 'E13': 27.6, 'E14': 29.8 },
    'E2': { 'E1': 10, 'E2': 0, 'E3': 8.5, 'E4': 14.8, 'E5': 26.2, 'E6': 29.1, 'E7': 26.1, 'E8': 17.3, 'E9': 10, 'E10': 3.5, 'E11': 15.5, 'E12': 20.9, 'E13': 19.1, 'E14': 21.8 },
    'E3': { 'E1': 18, 'E2': 8.5, 'E3': 0, 'E4': 6.3, 'E5': 18.2, 'E6': 20.6, 'E7': 17.6, 'E8': 13.6, 'E9': 9.4, 'E10': 10.3, 'E11': 19.5, 'E12': 19.1, 'E13': 12.1, 'E14': 16.6 },
    'E4': { 'E1': 24.8, 'E2': 14.8, 'E3': 6.4, 'E4': 0, 'E5': 18.2, 'E5': 12, 'E6': 14.4, 'E7': 11.5, 'E8': 12.4, 'E9': 12.6, 'E10': 16.7, 'E11': 23.6, 'E12': 18.6, 'E13': 10.6, 'E14': 15.4 },
    'E5': { 'E1': 36.4, 'E2': 26.2, 'E3': 18.2, 'E4': 12, 'E5': 0, 'E6': 3, 'E7': 2.4, 'E8': 19.4, 'E9': 23.3, 'E10': 28.2, 'E11': 34.2, 'E12': 24.8, 'E13': 14.5, 'E14': 17.9 },
...
class ParisMetroMap:
    ...
    def getDirectDistanceFromTo(self, originNodeID, finalNodeID):
        if originNodeID == finalNodeID:
            return 0
        elif distanciasDiretas[originNodeID][finalNodeID]:
            return distanciasDiretas[originNodeID][finalNodeID]
    
    def getRealDistanceFromTo(self, originNodeID, finalNodeID):
        if originNodeID == finalNodeID:
            return 0
